...
print(models[index], 'is the best model to detect whether the review is positive or negative. It has high accuracy and high f1_score of all.')
...
predict(text)
text = 'I did not love this place very much'
predict(text)
text = 'This hotel is not good'
predict(text)